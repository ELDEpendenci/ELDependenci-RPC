...
public class RPCRegistry implements ComponentsRegistry {
    ...
    public static class ELDRPCCommandBungee extends ELDRPCCommand<CommandSender> implements CommandNode {
    }


    public static class RPCTestCommandBungee extends RPCTestCommand<CommandSender> implements CommandNode {
